...
if __name__ == '__main__':
    ...
    parser.add_argument('--cookie-filename', help='cookie filename', default='cookies.json')
    parser.add_argument('--ascii-smileys', action='store_true',
                        help='display smileys in ascii')
    args = parser.parse_args()

    default_cookies_path = os.path.join(dirs.user_cache_dir, args.cookie_filename)
